...
-- 创建菜单
INSERT INTO c_resource (`id`, `code`, `title`, `name`, `resource_type`, `remarks`, `is_general`,`redirect`, `path`, `component`, `state`, `sort_value`, `icon`, `active_icon`,`group_`, `data_scope`, `custom_class`, `is_def`, `parent_id`, `tree_grade`,`tree_path`, `meta_json`, `created_by`, `created_time`, `updated_by`,`updated_time`) VALUES (${menuId}, '', '${table.menuName}',<#if table.popupType != POPUP_TYPE_JUMP>'${plusName}${table.entityName?uncap_first}List'<#else>''</#if>,<#if table.popupType != POPUP_TYPE_JUMP>'20'<#else>'10'</#if>, '', b'0', '','/${table.plusModuleName}/${table.entityName?uncap_first}',<#if table.popupType != POPUP_TYPE_JUMP>'${table.plusModuleName}/${table.entityName?uncap_first}/index.vue'<#else>'Layout'</#if>,b'1', 3, '${table.menuIcon!''}', '', '',NULL, NULL, NULL, ${parentMenuId}, 1, '/${parentMenuId}/','{\"defaultOpened\":false,\"permanent\":false,\"auth\":[],\"sidebar\":false,\"breadcrumb\":true,\"activeMenu\":\"\",\"cache\":[\"SystemMenuCreate\",\"SystemMenuEdit\"],\"noCache\":[],\"badge\":\"\",\"link\":\"\",\"iframe\":\"\",\"copyright\":false,\"paddingBottom\":\"0px\"}',${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>,  ${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);


<#if table.popupType == POPUP_TYPE_JUMP>
INSERT INTO c_resource (`id`, `code`, `title`, `name`, `resource_type`, `remarks`, `is_general`, `redirect`, `path`, `component`, `state`, `sort_value`, `icon`, `active_icon`, `group_`, `data_scope`, `custom_class`, `is_def`, `parent_id`, `tree_grade`, `tree_path`, `meta_json`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES (${menuListId}, '', '${table.menuName}列表', '${plusName}${table.entityName?uncap_first}List', '20', '', b'0', '', '', '${table.plusModuleName}/${table.entityName?uncap_first}/index.vue', b'1', 1, '', '', '', NULL, NULL, NULL, 1, 3, '/${parentMenuId}/${menuId}/','{\"defaultOpened\":false,\"permanent\":false,\"auth\":[],\"sidebar\":false,\"breadcrumb\":true,\"activeMenu\":\"/${table.plusModuleName}/${table.entityName?uncap_first}\",\"cache\":[\"${plusName}${table.entityName?uncap_first}Edit\"],\"noCache\":[],\"badge\":\"\",\"link\":\"\",\"iframe\":\"\",\"copyright\":false,\"paddingBottom\":\"0px\"}',${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>,  ${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
INSERT INTO c_resource (`id`, `code`, `title`, `name`, `resource_type`, `remarks`, `is_general`, `redirect`, `path`, `component`, `state`, `sort_value`, `icon`, `active_icon`, `group_`, `data_scope`, `custom_class`, `is_def`, `parent_id`, `tree_grade`, `tree_path`, `meta_json`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES (${menuEditId}, '', '${table.menuName}修改', '${plusName}${table.entityName?uncap_first}Edit', '20', '', b'0', '', '/${table.plusModuleName}/${table.entityName?uncap_first}/edit/:id', '${table.plusModuleName}/${table.entityName?uncap_first}/index.vue', b'1', 1, '', '', '', NULL, NULL, NULL, 1, 3, '/${parentMenuId}/${menuId}/','{\"defaultOpened\":false,\"permanent\":false,\"auth\":[],\"sidebar\":false,\"breadcrumb\":true,\"activeMenu\":\"/${table.plusModuleName}/${table.entityName?uncap_first}\",\"cache\":true,\"noCache\":[\"${plusName}${table.entityName?uncap_first}List\"],\"badge\":\"\",\"link\":\"\",\"iframe\":\"\",\"copyright\":false,\"paddingBottom\":\"0px\"}',${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>
,  ${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
</#if>
-- 创建按钮
<#if table.addShow>
...
INSERT INTO c_role_resource (`id`, `role_id`, `resource_id`, `created_time`, `created_by`, updated_by, updated_time)
VALUES (${rrMenuId}, ${roleId}, ${menuId}, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
<#if table.popupType == POPUP_TYPE_JUMP>
INSERT INTO c_role_resource (`id`, `role_id`, `resource_id`, `created_time`, `created_by`, updated_by, updated_time) VALUES (${rrMenuListId}, ${roleId}, ${menuListId}, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
...
<#if table.addShow>
INSERT INTO c_role_resource (`id`, `role_id`, `resource_id`, `created_time`, `created_by`, updated_by, updated_time) VALUES (${rrButtonAddId}, ${roleId}, ${buttonAddId}, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
</#if>
<#if table.editShow>
INSERT INTO c_role_resource (`id`, `role_id`, `resource_id`, `created_time`, `created_by`, updated_by, updated_time) VALUES (${rrButtonEditId}, ${roleId}, ${buttonEditId}, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
</#if>
<#if table.copyShow>
INSERT INTO c_role_resource (`id`, `role_id`, `resource_id`, `created_time`, `created_by`, updated_by, updated_time) VALUES (${rrButtonCopyId}, ${roleId}, ${buttonCopyId}, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
</#if>
<#if table.deleteShow>
INSERT INTO c_role_resource (`id`, `role_id`, `resource_id`, `created_time`, `created_by`, updated_by, updated_time) VALUES (${rrButtonDeleteId}, ${roleId}, ${buttonDeleteId}, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
</#if>
<#if table.viewShow>
INSERT INTO c_role_resource (`id`, `role_id`, `resource_id`, `created_time`, `created_by`, updated_by, updated_time) VALUES (${rrButtonViewId}, ${roleId}, ${buttonViewId}, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>, ${createdBy}, <#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
</#if>
