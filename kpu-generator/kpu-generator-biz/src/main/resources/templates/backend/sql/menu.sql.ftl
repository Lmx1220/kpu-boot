...
<#assign menuCode = "${table.plusApplicationName}:${table.plusModuleName?replace('/', ':')}:${table.entityName?uncap_first}"/>
-- 创建菜单
<#if table.popupType == POPUP_TYPE_JUMP>
INSERT INTO c_resource (`id`, `code`, `title`, `name`, `resource_type`, `remarks`, `is_general`, `redirect`, `path`, `component`, `state`, `sort_value`, `icon`, `active_icon`, `group_`, `data_scope`, `custom_class`, `is_def`, `parent_id`, `tree_grade`, `tree_path`, `meta_json`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES (${menuListId}, '', '${table.menuName}列表', '${plusName}${table.entityName}List', '20', '', b'0', '', '', '${table.plusApplicationName}/${table.plusModuleName}/${table.entityName?uncap_first}/list.vue', b'1', 1, '', '', '', NULL, NULL, NULL, 1, 3, '/${parentMenuId}/${menuId}/','{\"defaultOpened\":false,\"permanent\":false,\"auth\":[],\"sidebar\":false,\"breadcrumb\":false,\"activeMenu\":\"/${table.plusModuleName}/${table.entityName?uncap_first}\",\"cache\":[\"${plusName}${table.entityName?uncap_first}Edit\"],\"noCache\":[],\"badge\":\"\",\"link\":\"\",\"iframe\":\"\",\"copyright\":false,\"paddingBottom\":\"0px\"}',${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>,  ${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
INSERT INTO c_resource (`id`, `code`, `title`, `name`, `resource_type`, `remarks`, `is_general`, `redirect`, `path`, `component`, `state`, `sort_value`, `icon`, `active_icon`, `group_`, `data_scope`, `custom_class`, `is_def`, `parent_id`, `tree_grade`, `tree_path`, `meta_json`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES (${menuEditId}, '', '${table.menuName}修改', '${plusName}${table.entityName}Edit', '20', '', b'0', '', '/${table.plusApplicationName}/${table.plusModuleName}/${table.entityName?uncap_first}/edit/:id', '${table.plusApplicationName}/${table.plusModuleName}/${table.entityName?uncap_first}/edit.vue', b'1', 1, '', '', '', NULL, NULL, NULL, 1, 3, '/${parentMenuId}/${menuId}/','{\"defaultOpened\":false,\"permanent\":false,\"auth\":[],\"sidebar\":false,\"breadcrumb\":true,\"activeMenu\":\"/${table.plusModuleName}/${table.entityName?uncap_first}\",\"cache\":true,\"noCache\":[\"${plusName}${table.entityName?uncap_first}List\"],\"badge\":\"\",\"link\":\"\",\"iframe\":\"\",\"copyright\":false,\"paddingBottom\":\"0px\"}',${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>, ${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
<#else>
INSERT INTO c_resource (`id`, `code`, `title`, `name`, `resource_type`, `remarks`, `is_general`,`redirect`, `path`, `component`, `state`, `sort_value`, `icon`, `active_icon`,`group_`, `data_scope`, `custom_class`, `is_def`, `parent_id`, `tree_grade`,`tree_path`, `meta_json`, `created_by`, `created_time`, `updated_by`,`updated_time`) VALUES (${menuId}, '', '${table.menuName}',<#if table.popupType != POPUP_TYPE_JUMP>'${plusName}${table.entityName}List'<#else>''</#if>,<#if table.popupType != POPUP_TYPE_JUMP>'20'<#else>'10'</#if>, '', b'0', '','/${table.plusApplicationName}/${table.plusModuleName}/${table.entityName?uncap_first}',<#if table.popupType != POPUP_TYPE_JUMP>'${table.plusApplicationName}/${table.plusModuleName}/${table.entityName?uncap_first}/index.vue'<#else>'Layout'</#if>,b'1', 3, '${table.menuIcon!''}', '', '',NULL, NULL, NULL, ${parentMenuId}, 1, '/${parentMenuId}/','{\"defaultOpened\":false,\"permanent\":false,\"auth\":[],\"sidebar\":true,\"breadcrumb\":true,\"activeMenu\":\"\",\"cache\":[],\"noCache\":[],\"badge\":\"\",\"link\":\"\",\"iframe\":\"\",\"copyright\":false,\"paddingBottom\":\"0px\"}',${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>,  ${createdBy},<#if dbType == oracle>to_date('${datetime}', 'yyyy-MM-dd HH24:mi:ss')<#else>'${datetime}'</#if>);
</#if>
