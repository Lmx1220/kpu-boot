...
import type { ${table.entityName}PageQuery, ${table.entityName}ResultVO } from '@/api/modules/${table.plusApplicationName}/${table.plusModuleName}/model/${table.entityName?uncap_first}Model'
