...
<script lang="ts">
  ...
  import Editor from './edit.vue.ftl'
  </#if>
  ...
  import { PermCode } from '/~/${table.plusApplicationName}/enums/permCode'
  import { columns, searchFormSchema } from './schema'
  <#if table.superClass == SUPER_CLASS_SUPER_POI_CLASS>
  import { page, remove, importFile, exportFile, exportPreview } from '/~/${table.plusApplicationName}/api/${table.plusModuleName}/${table.entityName?uncap_first}'
  <#else>
  import { page, remove } from '/~/${table.plusApplicationName}/api/${table.plusModuleName}/${table.entityName?uncap_first}';
  </#if>
