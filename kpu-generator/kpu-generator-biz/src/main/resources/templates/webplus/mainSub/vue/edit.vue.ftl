...
<script lang="ts">
    ...
    import {Api, getValidateRules, save, update} from '/@/api/';
    import ${sub.table.entityName}Modal, {customFormSchemaRules, editFormSchema} from './';
    ...
    export default defineComponent({
        ...
        components: {
            ${sub.table.entityName}Modal,
            <#if table.popupType == POPUP_TYPE_MODAL>BasicModal<#elseif table.popupType == POPUP_TYPE_DRAWER>BasicDrawer<#else></#if>,
            BasicForm
        },
                ...
                async function handleSubmit() {
                    try {
                        ...
                        const {
                            ...
                            removeRecords,
                            updateRecords
                        } = get${sub.table.entityName}Ref().getRecordset();
