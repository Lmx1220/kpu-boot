...
<script lang="ts">
  ...
  import ${sub.table.entityName}Modal from '../../../../../../../../../../../../../Downloads/lamp-generator/lamp-generator-server/src/main/resources/templates/webplus/mainSub/vue${sub.table.entityName?uncap_first}/index';
