...
//import cn.lmx.kpu.common.api.LogApi;
...
//        } else {
//            // 增量追加 server pom文件
//            String dependencyStr = StrUtil.format("        <dependency>\n" +
//                    "            <groupId>{}</groupId>\n" +
//                    "            <artifactId>{}-{}-controller</artifactId>\n" +
//                    "            <version>\\${{}-project.version}</version>\n" +
//                    "        </dependency>", vo.getGroupId(), projectPrefix, vo.getServiceName(), projectPrefix);
...
//                    "        </dependency>", vo.getGroupId(), projectPrefix, vo.getServiceName(), projectPrefix);
//
//            tips.append("1. 请在 kpu-boot-server/pom.xml 中加入以下 代码：\n");
