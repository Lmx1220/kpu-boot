...
//        putDictType(EchoDictType.Gateway.class);
    ...
    private static String joinPackage(GenTable genTable, GeneratorConfig generatorConfig, String functionPackage) {
    ...
    public static Map<String, Object> getImportPackages(DbType dbType, GenTable genTable, GeneratorConfig generatorConfig, List<GenTableColumn> fieldList, Map<String, Object> objectMap) {
        Map<String, Object> map = new HashMap<>();
    ...
    private static void importType(DbType dbType, Set<String> saveVoImportPackages, Set<String> updateVoImportPackages, Set<String> resultVoImportPackages,
                                   Set<String> pageQueryImportPackages, Set<String> entityImportPackages, EntityConfig entityConfig, GenTableColumn field) {
    ...
    private static void importValid(Set<String> saveVoImportPackages, Set<String> updateVoImportPackages, GenTableColumn field) {
    ...
    private static void importEntity(Set<String> entityImportPackages, EntityConfig entityConfig, GenTableColumn field) {
        if (field.getIsPk()) {
    ...
    private static void importEnum(GenTable genTable, GeneratorConfig generatorConfig, Map<String, Object> objectMap, Set<String> saveVoImportPackages, Set<String> updateVoImportPackages, Set<String> resultVoImportPackages, Set<String> pageQueryImportPackages, Set<String> entityImportPackages, Set<String> enumImportPackages, EntityConfig entityConfig, Set<EnumType> etList, GenTableColumn field) {
        if (StrUtil.isNotEmpty(field.getEnumStr())) {
            ...
            if (enumType != null) {
                ...
                enumImportPackages.add(ApiModel.class.getCanonicalName());
                enumImportPackages.add(ApiModelProperty.class.getCanonicalName());
    ...
    private static void importEcho(GeneratorConfig generatorConfig, Set<String> resultVoImportPackages, Set<EchoType> echoList, GenTableColumn field) {
    ...
    private static void importTs(GeneratorConfig generatorConfig, Set<String> dataTsImport, GenTableColumn field) {
    ...
    private static void importVO(GenTable genTable, Set<String> saveVoImportPackages, Set<String> updateVoImportPackages, Set<String> resultVoImportPackages, Set<String> pageQueryImportPackages, Set<String> entityImportPackages) {
        // VO-实体 公共部分导包
        ...
        // VO 公共包
        saveVoImportPackages.add(ApiModel.class.getCanonicalName());
        saveVoImportPackages.add(ApiModelProperty.class.getCanonicalName());
    ...
    private static void importMainSub(GenTable genTable, Map<String, Object> objectMap, Set<String> saveVoImportPackages, Set<String> updateVoImportPackages, Set<String> serviceImplImportPackages) {
        if (TplEnum.MAIN_SUB.eq(genTable.getTplType())) {
            ...
            serviceImplImportPackages.add(LbqWrapper.class.getCanonicalName());
        }
    }

    private static void importTreeEntity(GenTable genTable, Set<String> serviceImportPackages, Set<String> serviceImplImportPackages, Set<String> controllerImportPackages) {
        if (EntitySuperClassEnum.TREE_ENTITY.eq(genTable.getEntitySuperClass())) {
            ...
            controllerImportPackages.add(ApiOperation.class.getCanonicalName());
            controllerImportPackages.add(PostMapping.class.getCanonicalName());
            controllerImportPackages.add(SysLog.class.getCanonicalName());
        }
    }

    private static void importServiceImpl(GenTable genTable, Set<String> serviceImplImportPackages) {
        // 后面会判断是否需要导入
        if (genTable.getIsDs()) {
    ...
    private static void importManagerImpl(GenTable genTable, Set<String> managerImplImportPackages) {
        if (genTable.getIsLombok()) {
    ...
    private static void importController(GenTable genTable, Set<String> controllerImportPackages) {
        if (genTable.getIsLombok()) {
        ...
        controllerImportPackages.add(Api.class.getCanonicalName());
    ...
    public static Map<String, Object> getMvcPackage(GenTable genTable, GeneratorConfig generatorConfig, Map<String, Object> packageMap) {
        ...
        String baseVoName = getName(genTable.getEntityName(), entityConfig.getFormatBaseVoFileName(), GenCodeConstant.BASE_VO);
        map.put("baseVoName", baseVoName);
    ...
    public static String getName(String entityName, String format, String Suffix) {
