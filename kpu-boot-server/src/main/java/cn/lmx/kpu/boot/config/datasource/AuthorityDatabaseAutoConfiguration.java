//package cn.lmx.kpu.boot.config.datasource;
//
//import com.baomidou.mybatisplus.autoconfigure.ConfigurationCustomizer;
//import com.baomidou.mybatisplus.autoconfigure.MybatisPlusProperties;
//import com.baomidou.mybatisplus.autoconfigure.MybatisPlusPropertiesCustomizer;
//import cn.lmx.basic.database.datasource.defaults.BaseMasterDatabaseConfiguration;
...
//
///**
// * kpu.database.multiTenantType != DATASOURCE 时，该类启用.
// * 此时，项目的多租户模式切换成：${kpu.database.multiTenantType}。
// * <p>
// * NONE("非租户模式"): 不存在租户的概念
...
// * @date 2023/7/4 14:27
// * 断点查看原理：👇👇👇
// * @see cn.lmx.basic.database.datasource.BaseMybatisConfiguration#mybatisPlusInterceptor()
// * @see cn.lmx.basic.boot.interceptor.HeaderThreadLocalInterceptor
// */
//@Configuration
//@Slf4j
//@MapperScan(
...
//@ConditionalOnExpression("!'DATASOURCE'.equals('${kpu.database.multiTenantType}') && !'DATASOURCE_COLUMN'.equals('${kpu.database.multiTenantType}') ")
...
//        log.debug("检测到 kpu.database.multiTenantType!=DATASOURCE，加载了 AuthorityDatabaseAutoConfiguration");
//    }
//
//}
