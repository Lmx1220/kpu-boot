...
import cn.lmx.kpu.msg.strategy.domain.cl.ClSendResult;
...
@Component("CL")
@Slf4j
public class ClSmsMsgStrategyImplStrategy implements MsgStrategy {
    //带变量发送url
...
//    public ClSmsMsgStrategyImplStrategy(TaskMapper smsTaskMapper, SendStatusService smsSendStatusService) {
