...
public class TencentSmsMsgStrategyImpl implements MsgStrategy {
    ...
    public MsgResult exec(MsgParam msgParam) throws Exception {
        ...
        String[] phoneNumbers = recipientList.stream().map(MsgRecipient::getRecipient).toArray(String[]::new);
        ...
        req.setSign(msgTemplate.getSign());

        /* 模板 ID: 必须填写已审核通过的模板 ID */
        // 模板 ID 可前往 [国内短信](https://console.cloud.tencent.com/smsv2/csms-template) 或 [国际/港澳台短信](https://console.cloud.tencent.com/smsv2/isms-template) 的正文模板管理查看
        req.setTemplateID(msgTemplate.getTemplateCode());

        String paramStr = msg.getParam();
        ...
        req.setSessionContext(String.valueOf(msg.getId()));
