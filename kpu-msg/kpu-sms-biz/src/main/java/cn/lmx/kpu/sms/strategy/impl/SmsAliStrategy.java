...
import cn.lmx.kpu.sms.strategy.domain.MsgResult;
import cn.lmx.kpu.sms.strategy.domain.cl.AliSmsProperty;
...
public class SmsAliStrategy extends AbstractSmsStrategy {
    ...
    public SmsAliStrategy(ESmsTaskMapper smsTaskMapper, ESmsSendStatusService smsSendStatusService) {
